...
export const en = {
  ...
  usage: {
    ...
    contextUsed: (used: string, window: string): string => `${used} / ${window} used`,
    systemPromptLabel: 'System prompt (est.)',
    toolsLabel: 'Tools (est.)',
    contextMessagesLabel: 'Messages (est.)',
    freeSpaceLabel: 'Free space',
    windowLabel: 'Context window',
    cacheHitLabel: 'Cache hit rate',
    cacheReadLabel: 'Total cache read',
    cacheWriteLabel: 'Total cache write',
    estimateNote: 'Breakdown is a local estimate; it uses a different basis than the reported usage',
