...
export const en = {
  ...
  flow: {
    ...
    compactBusy: 'Context compaction is already in progress.',
    compactNoImages: 'The compact command cannot carry images. Remove the attachments.',
    commandUnhandled: (name: string): string => `The /${name} command is not available.`,
  ...
  composer: {
    ...
    groupSkills: 'Skills',
    groupFiles: 'Files',
    /** 补全弹层里内置命令 /compact 的描述 */
    builtinCompactDescription: 'Compact the context; trailing text sets what to keep',
