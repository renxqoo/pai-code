...
export const en = {
  ...
  settings: {
    ...
    agentsFieldNameHint: 'Invoke name and file name; starts with a letter or digit, may contain . _ -',
    ...
    agentsNameInvalid: 'Name must start with a letter or digit and may contain . _ - only.',
