...
export const zh: typeof en = {
  ...
  usage: {
    ...
    toolCallsLabel: '工具调用',
    contextTitle: '上下文',
    contextUsed: (used: string, window: string): string => `已用 ${used} / ${window}`,
    systemPromptLabel: '系统提示词（估算）',
    toolsLabel: '工具（估算）',
    contextMessagesLabel: '消息（估算）',
    freeSpaceLabel: '剩余空间',
    windowLabel: '上下文窗口',
    cacheHitLabel: '缓存命中率',
    cacheReadLabel: '累计缓存读',
    cacheWriteLabel: '累计缓存写',
    estimateNote: '分项为本地估算，与实报占用口径不同',
    cumulativeTitle: '累计',
