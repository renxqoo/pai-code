...
function QueuePanel({ steering, followUp, onClear }: QueuePanelProps) {
  ...
  return (
    <div className={`${CONVERSATION_COLUMN_CLASS} pointer-events-auto mb-[8px] rounded-[12px] border border-border bg-background px-[14px] py-[10px] shadow-[0_10px_24px_-14px_rgba(24,24,28,0.3)]`}>
